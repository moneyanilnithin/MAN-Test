...
function renderData(data) {
  ...
  if (!Array.isArray(data)) {
    ...
    throw new Error(
      "Language data must contain an array"
    );
...
async function loadData(
  ...
  try {
    ...
    if (
      languageCache.has(source)
    ) {

      const cachedData =
        languageCache.get(source);
    ...
    console.error(
      "Village portal data loading failed:",
      error
    );
    ...
    button.addEventListener(
      ...
      async () => {
        ...
        try {
          ...
          console.error(
            `Failed to load ${language} language data:`,
            error
          );

          /* -------------------------------
             KEEP PREVIOUS LANGUAGE ACTIVE
          ------------------------------- */
...
/* =========================================
   START WITH DEFAULT VILLAGE apps.json
========================================= */
